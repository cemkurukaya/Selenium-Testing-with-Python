...
chrome_path = "" #chrome driver path

profile_path = "" #firefox profile path
options = Options()
options.set_preference('profile', profile_path)
service = Service("") #firefox driver path
...
def test_chrome_ebay():
    ...
    driver.find_element(By.XPATH , """//*[@id="mainContent"]/form/div[2]/div[1]/div[2]/ul/li[2]/div/a/span/span""").click() #add to basket with xpath, look img/xpath0.png
...
def test_firefox_ebay():
    ...
    fdriver.find_element(By.XPATH , """//*[@id="mainContent"]/form/div[2]/div[1]/div[2]/ul/li[2]/div/a/span/span""").click() #add to basket with xpath, look img/xpath0.png
...
def test_chrome_amazon():
    ...
    driver.find_element(By.XPATH, '//*[@id="s-refinements"]/div[1]/ul/li[3]/span/a/span[2]').click()  # opening navigation menu - "shop by category"
    driver.find_element(By.CSS_SELECTOR, 'body > div:nth-child(1) > div:nth-child(30) > div:nth-child(11) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > span:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > ul:nth-child(2) > li:nth-child(2) > span:nth-child(1) > a:nth-child(1) > span:nth-child(1)').click()  # > to pet supplies
    driver.find_element(By.XPATH, "//span[contains(text(),'Aircraft Accessories')]").click()  # to the dog supplies with image
    ...
    driver.get("https://library.sportingnews.com/styles/crop_style_16_9_desktop/s3/2022-12/Lionel%20Messi%20Argentina%20kiss%20World%20Cup%20trophy%20121822.jpg?itok=uwTJ349K")
    time.sleep(5)
...
def test_firefox_amazon():
    ...
    fdriver.find_element(By.XPATH, '//*[@id="s-refinements"]/div[1]/ul/li[3]/span/a/span[2]').click()  # opening navigation menu - "shop by category"
    fdriver.find_element(By.CSS_SELECTOR, 'body > div:nth-child(1) > div:nth-child(30) > div:nth-child(11) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > span:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > ul:nth-child(2) > li:nth-child(2) > span:nth-child(1) > a:nth-child(1) > span:nth-child(1)').click()  # > to pet supplies
    fdriver.find_element(By.XPATH, "//span[contains(text(),'Aircraft Accessories')]").click()  # to the dog supplies with image
    ...
    fdriver.get("https://library.sportingnews.com/styles/crop_style_16_9_desktop/s3/2022-12/Lionel%20Messi%20Argentina%20kiss%20World%20Cup%20trophy%20121822.jpg?itok=uwTJ349K")
    time.sleep(5)

#choose the function you want and uncomment it.
